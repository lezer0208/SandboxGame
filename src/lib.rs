...
#[derive(Debug)]
pub struct SandboxGameProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SandboxGameProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SandboxGame processing");
    
    let mut processor = SandboxGameProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SandboxGameProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SandboxGameProcessor::new(false);
